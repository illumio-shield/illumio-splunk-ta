...
class ConfigurationSetting(property):
    ...
    def __init__(
        self, fget=None, fset=None, fdel=None, doc=None, name=None, readonly=None, value=None
    ):
    ...
    class View(OrderedDict):
        ...
        def __init__(self, command):
            ...
            OrderedDict.__init__(
                self, ((option.name, item_class(command, option)) for (name, option) in definitions)
            )
